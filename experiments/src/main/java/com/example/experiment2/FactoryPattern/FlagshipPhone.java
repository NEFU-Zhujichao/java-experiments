...
public class FlagshipPhone extends Phone{
    private String CPU;
    ...
    public FlagshipPhone(String CPU, String memory, String battery, String screen, String camera, String GPS, String fingerIdentification, String NFC) {
        this.CPU = CPU;
        this.memory = memory;
